...
#             host = "ws://www.hesper.site:3000/"
        ...
        print("WsClient.init server_name" + self.server_info['servers']['default']['server_name'])
        print("WsClient.init ws_port" + str(self.server_info['servers']['default']['port']))
        self.host = "ws://" + self.server_info['servers']['default']['server_name'] + ":" + str(self.server_info['servers']['default']['ws_port']) + "/"
